 ...
 * @author liyu
 */
public class GetMaxDayUDAF extends AbstractGenericUDAFResolver {
    @Override
    public GenericUDAFEvaluator getEvaluator(TypeInfo[] param) throws SemanticException {
        ...
        return new GetMaxDayUDAFEvaluator();
    }

    public static class GetMaxDayUDAFEvaluator extends GenericUDAFEvaluator {
        ...
        public AggregationBuffer getNewAggregationBuffer() throws HiveException {
            MaxDateAgg maxDateAgg = new MaxDateAgg();
            return maxDateAgg;
        }
